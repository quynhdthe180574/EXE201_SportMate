...
public class FieldDao {
    ...
    public List<Map<String, Object>> getAllFields(int page, int pageSize, String sortBy, String order)
            throws SQLException {
    ...
    public List<Map<String, Object>> searchAndFilterFields(
        ...
        sql.append(
                " GROUP BY f.field_id, f.field_name, v.venue_name, p.province_name, d.district_name, st.sport_name, v.open_time, v.close_time, v.address_detail");
    ...
    public List<Map<String, Object>> getAvailableFields(
        ...
        sql.append(
                " GROUP BY f.field_id, f.field_name, v.venue_name, p.province_name, d.district_name, st.sport_name,"
    ...
    public List<Map<String, Object>> getAvailableSlots(int fieldId, java.sql.Date bookingDate) throws SQLException {
        ...
        String sqlWithBooking = """
                ...
                LEFT JOIN Booking b ON fp.field_id = ? AND b.slot_id = ts.slot_id
                    AND b.booking_date = ? AND (b.booking_status IS NULL OR b.booking_status != 'cancelled')
        ...
        try (PreparedStatement ps = connection.prepareStatement(sqlWithBooking)) {
            ...
            System.err.println("Lỗi kiểm tra slot trống (Bookings chưa tồn tại?): " + e.getMessage()
                    + " → Dùng fallback tất cả slot trống.");
