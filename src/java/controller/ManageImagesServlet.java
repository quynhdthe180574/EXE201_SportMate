...
public class ManageImagesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/owner/manage-images.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (success) {
            response.sendRedirect(request.getContextPath() + "/owner/manage-images?fieldId=" + fieldId + "&success=added");
        } else {
