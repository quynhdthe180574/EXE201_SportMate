...
<head>
    ...
    <style>
        ...
        .hero-section {background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; padding: 80px 0; text-align: center;}
        .hero-section h1 {font-size: 3rem; font-weight: 700;}
        .hero-section p {font-size: 1.25rem; opacity: 0.9;}
        .filter-card {background: white; border-radius: 16px; box-shadow: 0 10px 30px rgba(0,0,0,0.08); padding: 24px;}
        .venue-card {
            background: white;
            border-radius: 16px;
            overflow: hidden;
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link fw-medium" href="login.jsp">Đăng nhập</a></li>
                    <li class="nav-item"><a class="nav-link fw-medium btn btn-outline-light ms-3 px-4" href="register.jsp">Đăng ký</a></li>
                    <li class="nav-item"><a class="nav-link fw-medium btn btn-outline-light ms-3 px-4" href="profile.jsp">Trang cá nhân</a></li>
