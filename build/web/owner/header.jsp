        ...
        <header>
            <div class="nav-container">
                ...
                <nav>
                    ...
                    <a href="${pageContext.request.contextPath}/owner/booking_list.jsp">Quản lý đặt sân</a>
                    <a href="${pageContext.request.contextPath}/owner/manage-timeslots.jsp">
                        Quản lý khung giờ
                    </a>

                    <a href="${pageContext.request.contextPath}/owner/manage-images.jsp">
                        Quản lý ảnh
                    </a>
                    <a href="${pageContext.request.contextPath}/logout" style="color:var(--pink-pastel);">Đăng xuất</a>
                </nav>
            </div>
        </header>
